...
public class Constants {
  ...
  public static  double MISSILE_RADIUS = 50; // to optimise, id=5
  public static  int MISSILE_MAX_TTL = 300; // to optimise, id=6
  public static final int MISSILE_DESTRUCTIVE_POWER = 1;

  public static final double GRAVITY = 0;
  public static  double FRICTION = 0.01; // to optimise, id=9
